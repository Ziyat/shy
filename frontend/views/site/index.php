...
<section class="carousel carousel-fade slide home-slider" id="c-slide" data-ride="carousel" data-interval="4500" data-pause="false">
   ...
   <div class="carousel-inner">
      <div class="item active" style="background: url(http://www.wowthemes.net/demo/calypso/img/demo/bg.jpg);">
         <div class="container">
            <div class="row">
                  ...
                  <ul id="carousel-projects">
                     ...
                     <li>
                        <div class="boxcontainer">
                           <img src="http://www.wowthemes.net/demo/calypso/img/demo/showcase1.jpg" alt="">
                           <div class="roll">
                              <div class="wrapcaption">
                                 <a href="projectdetail.html"><i class="icon-link captionicons"></i></a>
                                 <a data-gal="prettyPhoto[gallery1]" href="http://www.wowthemes.net/demo/calypso/img/demo/showcase1.jpg" title="La Chaux De Fonds"><i class="icon-zoom-in captionicons"></i></a>
                              </div>
                           </div>
                     ...
                     <li>
                        <div class="boxcontainer">
                           <img src="http://www.wowthemes.net/demo/calypso/img/demo/showcase2.jpg" alt="">
                           <div class="roll">
                              <div class="wrapcaption">
                                 <a href="projectdetail.html"><i class="icon-link captionicons"></i></a>
                                 <a data-gal="prettyPhoto[gallery1]" href="http://www.wowthemes.net/demo/calypso/img/demo/showcase2.jpg" title="La Chaux De Fonds"><i class="icon-zoom-in captionicons"></i></a>
                              </div>
                           </div>
                     ...
                     <li>
                        <div class="boxcontainer">
                           <img src="http://www.wowthemes.net/demo/calypso/img/demo/showcase3.jpg" alt="">
                           <div class="roll">
                              <div class="wrapcaption">
                                 <a href="projectdetail.html"><i class="icon-link captionicons"></i></a>
                                 <a data-gal="prettyPhoto[gallery1]" href="http://www.wowthemes.net/demo/calypso/img/demo/showcase3.jpg" title="La Chaux De Fonds"><i class="icon-zoom-in captionicons"></i></a>
                              </div>
                           </div>
                     ...
                     <li>
                        <div class="boxcontainer">
                           <img src="http://www.wowthemes.net/demo/calypso/img/demo/showcase4.jpg" alt="">
                           <div class="roll">
                              <div class="wrapcaption">
                                 <a href="projectdetail.html"><i class="icon-link captionicons"></i></a>
                                 <a data-gal="prettyPhoto[gallery1]" href="http://www.wowthemes.net/demo/calypso/img/demo/showcase4.jpg" title="La Chaux De Fonds"><i class="icon-zoom-in captionicons"></i></a>
                              </div>
                           </div>
